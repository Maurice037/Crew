...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form id="cop" method="POST">
			<div>
				<textarea id="medtext" name="medtext"  type="text" class="form-control form-control-sm" rows="10" placeholder="An dieser Stelle schreibst du deinen gut ausformulierten Text..." required></textarea>
			</div>

      <input class="btn btn-danger" value="Absenden" name="sendmedtext" type="submit">
		</form>
