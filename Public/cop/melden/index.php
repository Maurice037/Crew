...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Kummerkasten</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="container-fluid">
    <form id="cop" method="POST">
			<div>
				<textarea id="coptext" name="coptext"  type="text" class="form-control form-control-sm" rows="10" placeholder="An dieser Stelle schreibst du deinen gut ausformulierten Text..." required></textarea>
			</div>

      <input class="btn btn-danger" value="Absenden" name="sendcoptext" type="submit">
		</form>
