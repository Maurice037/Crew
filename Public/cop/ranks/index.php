...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Beförderungen</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
   ...
   <div class="row">
			  ...
			  $ranki = "SELECT * FROM `crew_rankinfo` where uid='$uiduser' and type='cop' ORDER BY `crew_rankinfo`.`id` DESC ";
              ...
              if ($result = mysqli_query($db_game, $ranki)) {
