...
$check = $db_game->query("SELECT uid FROM players WHERE pid = '$steam' and mediclevel >= '9'");
if($check->num_rows == 0) {
			...
			<section class="content">
												...
												<div class="col-md-3 col-sm-6 col-12">
													<div class="info-box bg-gradient-danger">
														...
														<div class="info-box-content">
															...
															<span class="progress-description">
																<?php echo   (mysqli_num_rows(mysqli_query($db_game,"SELECT * FROM crew_note where uid='$uid_get' and type='med'")));   ?>
															</span>
														</div>
														<!-- /.info-box-content -->
													</div>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
				  <?php
              $note = "SELECT * FROM crew_note where uid='$uid_get' and type='med'";
			  ...
			  <div class="card-footer">
                <form  method="post">
                  <div class="input-group">
                    <input type="text" name="notem" placeholder="Notiz eintragen" class="form-control">
                    <span class="input-group-append">
                      <input type="submit" name="notemed" class="btn btn-primary" value="Abschicken" >
                    </span>
                  </div>
                </form>
              </div>
                      ...
                      <form method="post">
                        <input type="hidden" name="actionm" value="updatemLicenses" /><br />
                            ...
                            <td valign="top">
                              <table class="ui celled striped table">
                                ...
                                foreach ($licenses['med'] as $lic) {
                                  echo "<tr><td><input name='license_med_" . $lic[0] . "' type='checkbox' ";
                                  if (contains('[`license_med_' . $lic[0] . '`,1]', $med_licenses_get)) {
                                    echo "checked";
                                  }
                          ...
                          <tr>
                            <td>
                              <input type="submit" name="submitmed" value="Ausbildung eintragen" class="btn btn-danger" />
                            </td>
                          </tr>
                        </table>
                      </form>
										...
										<div class=" tab-pane" id="melden">
											...
											<form class="form-horizontal" method="post">
												<div class="form-group">
													...
													<input type="submit" name="medmelden" value="Update" class="btn btn-danger">
												</div>
										</div>
										</form>
            			  ...
            			  $kummertext = "SELECT * FROM crew_messege where uid='$uid_get' and type='med'  ";
											...
											<form class="form-horizontal" method="post">
												<div class="form-group">
													...
													<div class="form-group">
														...
														<select name="med" class="form-control">
															<?php
															foreach ($ranks['med'] as $k => $v) { ?>
																<option value="<?php echo $k ?>" <?php if ($mediclevel_get == $k) {
																											echo 'selected';
																										} ?>><?php echo $v ?></option>
															<?php
															}
													...
													<input type="submit" name="submitmedlvl" value="Speichern" class="btn btn-danger">
												</div>
										</div>
										</form>
									</div>
