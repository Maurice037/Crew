    ...
    <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $ranks['med'][$mediclevel]; ?><sup style="font-size: 20px"></sup></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php echo   (mysqli_num_rows(mysqli_query($db_game,"SELECT * FROM vehicles where pid='$steam'")));   ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?php echo  (mysqli_num_rows(mysqli_query($db_game,"SELECT * FROM houses where pid='$steam'")));  ?></h3>
